...
const FeatureCard = ({ title, description, icon: Icon, to, gradient = "from-novana-blue to-novana-purple" }: FeatureCardProps) => {
  return (
    ...
    >
      ...
      <div className="bg-black/30 backdrop-blur-lg border border-white/10 rounded-xl shadow-lg p-6 relative z-10 group-hover:border-transparent transition-all duration-300">
